...
?>
	<div class="mate matelen">
		...
		<a class="pull-right select_mate @if( count( @$selected_mate_arr ) && in_array(@$mate->id, @$selected_mate_arr) || (@$passedMateID == @$mate->id) ) mate-selected @endif" data-user="{{ $mate->id }}" href="javascript:void(0);"><i class="fa fa-check" ></i> SELECT MATE</a>
	</div>
<?php
	}
} 
