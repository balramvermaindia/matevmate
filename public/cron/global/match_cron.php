...
{
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://api.betfair.com/exchange/betting/json-rpc/v1"); // For Australian Exchange Server
			...
			if($bitfair_event['result_declared'] == 1){
				...
				if($total_user_get_data > 0 && $total_mate_get_data > 0){
					...
					if($user_data['id'] == $winner_user_id){
						...
						$mate_content	= "Hi ".$mate_data['firstname']." ".$mate_data['lastname'].",<br/><br/> Congratulations you won the challenge in ".$bitfair_event['name']." against ".$user_data['firstname']." ".$user_data['lastname'].".<br/><br/><br/> Thanks <br/> MateVMate Team";
						...
						$mate_content	= "Hi ".$mate_data['firstname']." ".$mate_data['lastname']."<br/> Result of the challenge in ".$bitfair_event['name']." against ".$user_data['firstname']." ".$user_data['lastname']." is out and there is tie between you and your mate.<br/> Thanks MateVMate Team";
					...
					$subject= "Result of match - ".$bitfair_event['name'];
